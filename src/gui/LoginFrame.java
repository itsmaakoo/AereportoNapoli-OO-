...
/**
 * La classe {@code LoginFrame} rappresenta l'interfaccia grafica per l'autenticazione
 * degli utenti nel sistema aeroportuale.
 * <p>
 * L'interfaccia consente all'utente di:
 * <ul>
 *     <li>Inserire username e password</li>
 *     <li>Effettuare il login come amministratore o utente generico</li>
 *     <li>Visualizzare un messaggio di errore in caso di credenziali errate</li>
 * </ul>
 * <p>
 * Lo sfondo è personalizzato con un'immagine e i campi di input sono stilizzati
 * con bordi arrotondati e placeholder.
 *
 */
public class LoginFrame extends JFrame {
    ...
    /**
     * Costruttore della finestra {@code LoginFrame}.
     * <p>
     * Inizializza l'interfaccia grafica, imposta lo sfondo, configura i campi
     * di input e collega il pulsante di login alle azioni di autenticazione.
     */
    public LoginFrame() {
        setTitle("Login");
    ...
    /**
     * Classe interna {@code roundedBorder} che definisce un bordo arrotondato personalizzato.
     */
    static class roundedBorder extends AbstractBorder {
        private final int radius;

        /**
         * Costruttore del bordo arrotondato.
         *
    ...
    /**
     * Aggiunge un testo segnaposto a un campo di testo.
     * <p>
     * Il testo viene mostrato in grigio e scompare quando il campo riceve il focus.
     *
     * @param field       il campo di testo a cui applicare il placeholder
     * @param placeholder il testo segnaposto da visualizzare
     */
    ...
    /**
     * Restituisce il campo di testo per l'username.
     *
     * @return il campo {@link JTextField} dell'username
     */
     ...
     *
     * @return il campo {@link JPasswordField} della password
     */
     ...
     *
     * @return il pulsante {@link JButton} di login
     */
